 ...
 * @returns {SVGElement} - The created SVG element
 */
export function svg_Progressbar_r(options, value) {
    // Create a new progress bar SVG element
    const svg = document.createElementNS("http://www.w3.org/2000/svg", "svg");
    svg.setAttribute("width", options.bar_width);
    svg.setAttribute("height", options.bar_height);
    ...
    bar_background.setAttribute("height", options.bar_height);
    bar_background.setAttribute("fill", options.bar_background_color);
    bar_background.setAttribute("rx", options.bar_height / 2); // Set horizontal radius for rounded corners
    bar_background.setAttribute("ry", options.bar_height / 2); // Set vertical radius for rounded corners
    svg.appendChild(bar_background);
    ...
    bar_value.setAttribute("height", options.bar_height);
    bar_value.setAttribute("fill", options.bar_color);
    bar_value.setAttribute("rx", options.bar_height / 2); // Set horizontal radius for rounded corners
    bar_value.setAttribute("ry", options.bar_height / 2); // Set vertical radius for rounded corners
    svg.appendChild(bar_value);
