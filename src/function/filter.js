export function orderValue(_options, _values) {
    switch(_options.orderOn){
        ...
        case "labels":
            if (_options.order === "asc" || _options.order === "desc") {
                _values.elements.sort((a, b) => _options.order === "asc" ? 
        ...
        default:
            ...
            if (_options.order === "asc" || _options.order === "desc") {
                _values.elements.sort((a, b) => _options.order === "asc" ? a.value - b.value : b.value - a.value);
            }
            break;
    }
